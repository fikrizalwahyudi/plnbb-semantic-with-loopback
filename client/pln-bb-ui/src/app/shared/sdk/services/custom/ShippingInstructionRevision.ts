...
/**
 * Api services for the `ShippingInstructionRevision` model.
 */
@Injectable()
export class ShippingInstructionRevisionApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ShippingInstructionRevision id
   *
   ...
   * This usually means the response is a `ShippingInstructionRevision` object.)
   * </em>
   */
