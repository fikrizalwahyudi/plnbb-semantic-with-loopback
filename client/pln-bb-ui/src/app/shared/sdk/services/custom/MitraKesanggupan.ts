...
export class MitraKesanggupanApi extends BaseLoopBackApi {
  ...
  /**
   * Find a related item by id for sumberTambang.
   *
   * @param {any} id MitraKesanggupan id
   *
   * @param {any} fk Foreign key for sumberTambang
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdSumberTambang(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/mitra_kesanggupan/:id/sumberTambang/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for sumberTambang.
   *
   * @param {any} id MitraKesanggupan id
   *
   * @param {any} fk Foreign key for sumberTambang
   ...
   */
  public destroyByIdSumberTambang(id: any, fk: any, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Update a related item by id for sumberTambang.
   *
   * @param {any} id MitraKesanggupan id
   *
   * @param {any} fk Foreign key for sumberTambang
   ...
   * </em>
   */
  public updateByIdSumberTambang(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Queries sumberTambang of MitraKesanggupan.
   *
   * @param {any} id MitraKesanggupan id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getSumberTambang(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/mitra_kesanggupan/:id/sumberTambang";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createSumberTambang(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Deletes all sumberTambang of this model.
   *
   * @param {any} id MitraKesanggupan id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteSumberTambang(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/mitra_kesanggupan/:id/sumberTambang";
    let _routeParams: any = {
  ...
  /**
   * Counts sumberTambang of MitraKesanggupan.
   *
   * @param {any} id MitraKesanggupan id
   *
   ...
   *  - `count` – `{number}` - 
   */
  public countSumberTambang(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/mitra_kesanggupan/:id/sumberTambang/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManySumberTambang(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/mitra_kesanggupan/:id/sumberTambang";
    let _routeParams: any = {
