...
@Component({
  selector: 'rencana-pasokan',
  templateUrl: './rencana-pasokan.component.html',
  styleUrls: ['./rencana-pasokan.component.sass']
})
export class RencanaPasokanComponent implements OnInit {
