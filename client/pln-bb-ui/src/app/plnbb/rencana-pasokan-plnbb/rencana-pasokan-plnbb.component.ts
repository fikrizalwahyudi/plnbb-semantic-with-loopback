...
@Component({
  selector: 'rencana-pasokan-plnbb',
  templateUrl: './rencana-pasokan-plnbb.component.html',
  styleUrls: ['./rencana-pasokan-plnbb.component.css']
})
export class RencanaPasokanPlnbbComponent implements OnInit {
